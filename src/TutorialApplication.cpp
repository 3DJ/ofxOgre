...
void TutorialApplication::createScene(void)
{
    ...
    aNode2->scale(scale1, scale1, scale1);
    ...
    aNode3->scale(scale1, scale1, scale1);
    ...
    aNode4->scale(scale2, scale2, scale2);
    ...
    bNode1->scale(scale2, scale2, scale2);
    ...
    bNode2->scale(scale1, scale1, scale1);
    ...
    bNode3->scale(scale1, scale1, scale1);
    bNode3->setPosition(10, 0, -10);
    ...
    bNode4->scale(scale2, scale2, scale2);
    ...
    cNode1->scale(scale2, scale2, scale2);
    ...
    cNode2->scale(scale1, scale1, scale1);
    ...
    cNode3->scale(scale1, scale1, scale1);
